...
public class Date2 implements java.io.Serializable, java.lang.Cloneable, java.lang.Comparable<java.util.Date> {
    ...
    public Date2() { throw new RuntimeException("Stub!"); }
    ...
    public Date2(long date) { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public Date2(int year, int month, int date) { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public Date2(int year, int month, int date, int hrs, int min) { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public Date2(int year, int month, int date, int hrs, int min, int sec) { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public Date2(java.lang.String s) { throw new RuntimeException("Stub!"); }
